...
const ProfileHeader = ({ driverData, onEditPress }) => {
    return (
                    ...
                    <View style={styles.textContainer}>
                        ...
                        <View style={styles.infoRow}>
                            <View style={styles.ratingBadge}>
                                ...
                                <Text style={styles.ratingText}>{driverData?.rating || '0.0'} Stars</Text>
                            </View>
                            <Text style={styles.memberText}>• {driverData?.memberSince || '2021'}</Text>
                        </View>
                    </View>
                </View>
            </View>
